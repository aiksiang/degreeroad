function displayRequirements() {
	...
	$(".sortable-view-requirement").append('<div class="sem"><div class="req-title">title</div><ul class="module-set"></ul><div class="sem-mcs">MC: 0/X</div></div>');
	$(".sortable-view-requirement").append('<div id="requirementList"></div>');
